...
import '../widgets/memory_media_editor.dart';
...
class MemoryDetailEditView extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<MemoryDetailEditView> createState() =>
      _MemoryDetailEditViewState();
}
...
class _MemoryDetailEditViewState extends ConsumerState<MemoryDetailEditView> {
  ...
  IconData _mediaIcon(MemoryMediaKind kind) {
    switch (kind) {
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: AppSizes.paddingLarge),
                  MemoryMediaEditor(memoryId: widget.memoryId),
                  const SizedBox(height: AppSizes.paddingLarge),
                  AppFormButtons(
                    primaryLabel: 'Guardar cambios',
                    onPrimaryPressed: () => _handleUpdate(memory),
                    secondaryLabel: 'Cancelar',
                    onSecondaryPressed: _handleCancel,
                    isProcessing: memoryControllerState.isLoading,
                  ),
                ],
              ),
            ),
...
class _MediaThumbnail extends StatelessWidget {
  const _MediaThumbnail({Key? key, required this.asset}) : super(key: key);
